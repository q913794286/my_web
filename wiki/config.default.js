...
var config = {
  ...
  // Your site title (format: page_title - site_title)Raneto
  site_title: '陈良鑫的知识库',
  ...
  copyright: 'Copyright &copy; ' + new Date().getFullYear() + ' - <a href="">Powered by clx</a>',
  ...
  // If authentication is enabled, set this to true to enable authentication for reading too身份验证
